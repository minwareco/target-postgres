...
| `max_buffer_seconds`        | `["integer", "null"]` | `1800` (15 minutes in seconds)     | The maximum number of seconds to buffer in memory before writing to the destination table in Postgres                                                                                                                                                                                                                                                                                 |
